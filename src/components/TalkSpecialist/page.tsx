...
export default function Specialist() {
    return(
        <div className="xl:relative w-full h-[115em] xl:h-[70em] flex flex-col gap-12">
            <Banner>Entre em Contato!</Banner>
            <div className="w-full xl:w-[60%] min-h-[20em] flex flex-col justify-center items-center mt-8" data-aos="fade-right">
                ...
                <div className="flex flex-col justify-center items-start gap-3">
                    ...
                    <div className="w-[45vh] md:w-[55vh] lg:w-[80vh] xl:w-[75vh] h-[40vh] md:h-[50vh] lg:h-[60vh] xl:h-[50vh]">
                        <iframe 
