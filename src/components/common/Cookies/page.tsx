...
export default function CookiePage() {
    ...
    return(
        <span className={`${siteCookie ? 'fixed' : 'hidden'} w-full bottom-0 z-20 lg:z-0 pt-0 lg:pt-[16em]`} data-aos="fade-up">
            {siteCookie && (
                <div className="w-full h-[15em] lg:h-[5em] bg-white flex justify-center items-center">
                    <div className="w-full lg:w-[80%] h-full flex flex-col lg:flex-row justify-center items-center gap-4">
                        ...
                        >
                            <button 
                            onClick={() => { setSiteCookie(false), setCookie(key, value, { path: '/', expires: expirationDate }) }}
