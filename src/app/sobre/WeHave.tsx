      ...
      <div className="w-[95%] xl:w-[20%] h-full flex items-center justify-center" data-aos="fade-right">
        ...
        >
          <div className="flex flex-col gap-2 justify-center items-center m-2">
            ...
            <h1 className="font-bold text-lg xl:text-xl">Missão</h1>
          </div>
          <p className="text-center m-5">
            Utilizar o avanço tecnológico para simplificar processos, aumentar a produtividade e reduzir custos
            operacionais, impulsionando o crescimento e a expansão dos nossos clientes.
          </p>
        </motion.div>
      </div>
      <div className="w-[95%] xl:w-[20%] flex items-center justify-center" data-aos="fade-up">
        ...
        >
          <div className="flex flex-col gap-2 justify-center items-center m-2">
            ...
            <h1 className="font-bold text-lg xl:text-xl">Visão</h1>
          </div>
          <p className="text-center m-5">
            Ser reconhecidos como líderes no mercado de soluções digitais, oferecendo uma interface intuitiva e
            funcionalidades avançadas que promovem agilidade e precisão na gestão de operações.
          </p>
        </motion.div>
      </div>
      <div className="w-[95%] xl:w-[20%] flex items-center justify-center" data-aos="fade-left">
        ...
        >
          <div className="flex flex-col gap-2 justify-center items-center m-2">
            ...
            <h1 className="font-bold text-lg xl:text-xl">Valores</h1>
          </div>
          <p className="text-center m-5">
            Temos o compromisso de entregar soluções de alta qualidade, enquanto buscamos continuamente a inovação e
            desempenhamos o papel de parceiro estratégico dos nossos clientes.
          </p>
        </motion.div>
      </div>
    </div>
